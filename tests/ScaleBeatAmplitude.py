...
for amplitude in scales:
    ...
    for frame in range(N_frames):
        ...
        flag1 = bem.SlenderCoordinates(r1_map[frame],v, flagellum_length=new_flag_length,flagellum_radius=0.2)
        
        flag2 = bem.SlenderCoordinates(r2_map[frame],v2, flagellum_length=new_flag_length,flagellum_radius=0.2)
