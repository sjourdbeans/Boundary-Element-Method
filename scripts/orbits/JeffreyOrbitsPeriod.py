...
for file in files:    
    ...
    for k, t in enumerate(time[:-1]):
        ...
        # print(v,omega)
    np.savetxt(f"/home/sjoerd-buitjes/University/Master-Thesis/Master-Thesis-Project/Data/BEM/python-BEM/orientation/Jeffrey-orbits/jeffrey_orbit_spheroid_b={mesh.b}_shear={round(gamma_dot,2)}_T={T}_with_dt={round(dt,3)}.txt",
