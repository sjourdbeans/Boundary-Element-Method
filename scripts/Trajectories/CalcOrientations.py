...
outdir = Path(f"/home/sjoerd-buitjes/University/Master-Thesis/Master-Thesis-Project/Data/BEM/python-BEM/trajectories/chlamy-3d/shear={round(shear_rate,1)}_N={n_sims}_periods_{n_periods}")
