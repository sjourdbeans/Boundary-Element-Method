...
meshfile = f"/scratch/sbuitjes/meshes/chlamy/chlamy_N={elements}.mat"

mesh = bem.Mesh(meshfile)

sys=bem.MobilityProblem(mesh)

outdir=Path(f"/scratch/sbuitjes/simulation_results/trajectory-sims/rigid-particles/ratio=1.25/mesh={elements}/shear={round(shear_rate,1)}_N={n_sims}_periods_{n_periods}")
